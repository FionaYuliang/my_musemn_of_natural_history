            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input class="form-control" id="message-text" type="email" name="email"
                           placeholder="Email" onblur="judgeEmail()">
                    <div class="tip-msg hidden">此邮箱已经注册过账号，选择<a href="/register">登录</a></div>
                </div>
                <div class="form-group">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="list-group" style="text-align: center">
                            <a href="/personal_home/commentBoard" target="_blank" class="list-group-item">登录后的留言板</a>
        ...
        <div class="row footer-buttom">
            <div class="beian">
                <ul class="list-inline text-center">
                    ...
                    <li><a href="#" target="_blank">北京市东城区天桥南大街126号 100050 电话:010-67024431 传真:010-67021254 </a></li>
                    </br>
                    <li><a href="#" target="_blank">电子信箱:office@bmnh.org.cn 网址:www.bmnh.org.cn 京公网安备110101003156号</a>
                    </li>
                </ul>
            </div>
        </div>
